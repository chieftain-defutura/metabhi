  ...
  render() {
    ...
    return (
      <NodeEditor description={ModelNodeEditor.description} {...this.props}>
        ...
        <InputGroupSction>
          <InputGroup name="Collidable"></InputGroup>
          <BooleanToggle>
            <BooleanInput value={node.collidable} onChange={this.onChangeCollidable} />
          </BooleanToggle>
        </InputGroupSction>
        <InputGroupSction>
          <InputGroup name="Walkable"></InputGroup>
          <BooleanToggle>
        ...
        <InputGroupSction>
          <InputGroup name="Receive Shadow"></InputGroup>
          <BooleanToggleShadow>
            <BooleanInput value={node.receiveShadow} onChange={this.onChangeReceiveShadow} />
          </BooleanToggleShadow>
        </InputGroupSction>
        <InputGroupSction>
          <InputGroup name="Combine"></InputGroup>
          <BooleanToggle>
        ...
        <InputGroupSction>
          <InputGroup
            name="Billboard"
            info="Model always faces user in Hubs. Does not billboard in Spoke."
          ></InputGroup>
          <BooleanToggle>
