// import React, { Component, Suspense, lazy, useLayoutEffect } from "react";
...
//     if (!theme) this.setState({ ...this.state, theme: "light" });
//     else if (JSON.parse(theme) === "light") this.setState({ ...this.state, theme: "light" });
//     else this.setState({ ...this.state, theme: "dark" });
//   }
...
//             <ThemeProvider theme={this.state.theme === "dark" ? theme : darkTheme}>
...
//                       <Layouts>
//                         <Switch>
//                           <Route exact path="/layouts" component={Dashboard} />
//                           <Route path="/layouts/template" component={CardTemplate} />
//                         </Switch>
//                       </Layouts>
//                     </Route>
